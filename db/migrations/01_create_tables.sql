...
--booking_table
Create Table booking (booking_id serial primary key, booking_date date, property_id integer, booked_by integer, start_date date, end_date date, price decimal(7,2), booking_status integer);
--calendar_table
